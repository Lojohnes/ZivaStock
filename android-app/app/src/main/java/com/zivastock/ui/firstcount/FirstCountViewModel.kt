...
@HiltViewModel
class FirstCountViewModel @Inject constructor(
    ...
    val allCounts: LiveData<List<FirstCountEntity>> = firstCountRepository.getAll().asLiveData()
    ...
    fun saveCount(
        ...
        viewModelScope.launch {
            ...
            val result = runCatching { firstCountRepository.save(entity) }
